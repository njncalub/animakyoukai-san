...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field people on 'Meeting'
        m2m_table_name = db.shorten_name(u'activities_meeting_people')
        ...
        # Changing field 'Meeting.name'
        db.alter_column(u'activities_meeting', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field people on 'Meeting'
        db.delete_table(db.shorten_name(u'activities_meeting_people'))


        # Changing field 'Meeting.name'
        db.alter_column(u'activities_meeting', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
